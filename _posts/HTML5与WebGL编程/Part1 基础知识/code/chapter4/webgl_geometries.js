...
function init() {
    ...
    scene.add(object);
    // create Geometry Object
    object = new THREE.Mesh(new THREE.BoxGeometry(100, 100, 100, 3, 2, 1), new THREE.MeshBasicMaterial({
        map: map,
        wireframe: true
    }));
...
function render() {
    ...
    for (var i = 0, l = scene.children.length; i < l; i += 1) {
